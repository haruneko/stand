...
//-----------------------------------------------------------------------------
int GetWedgeInOneSection(const double *x, int x_length, int fs, const double *f0,
...
void GetWedgeList(const double *x, int x_length, int number_of_voiced_sections,
    int *start_list, int *end_list, int fs, double frame_period, const double *f0,
    int *wedge_list) {
...
// This function is only used in platinum()
//-----------------------------------------------------------------------------
void GetTemporalBoundaries(const double *f0, int f0_length,
...
// This function is only used in platinum()
//-----------------------------------------------------------------------------
int GetNumberOfVoicedSections(const double *f0, int f0_length) {
...
// This function is only used in GetPulseLocations().
//-----------------------------------------------------------------------------
void GetTotalPhase(const double *f0, int f0_length, int x_length, const double *time_axis,
...
// This function is only used in Platinum().
//-----------------------------------------------------------------------------
int GetPulseLocations(const double *x, int x_length, int fs, const double *f0,
    int f0_length, const double *time_axis, double frame_period,
...
void Platinum(const double *x, int x_length, int fs, const double *time_axis, const double *f0,
  ...
  for (int i = 1; i < f0_length; ++i) {
    ...
    for (int j = 0; j <= fft_size / 2; ++j)
      minimum_phase.log_spectrum[j] = log(spectrogram[i][j] + DBL_MIN) / 2.0;
